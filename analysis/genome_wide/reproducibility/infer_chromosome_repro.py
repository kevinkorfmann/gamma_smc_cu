...
RESULTS_BASE = os.path.join(DATA, "reproducibility", "results")
RESULTS_DIR = RESULTS_BASE  # possibly overridden via --subdir
...
PAIR_CHUNK = 1000  # overridden by --pair-chunk
...
def main():
    ...
    parser.add_argument("--pair-chunk", type=int, default=1000, help="Pair chunk size")
    parser.add_argument("--subdir", type=str, default="", help="Subdir under results/ to write into")
    parser.add_argument(
        "--populations",
        nargs="*",
        default=None,
    ...
    global PAIR_CHUNK, RESULTS_DIR
    PAIR_CHUNK = args.pair_chunk
    if args.subdir:
        RESULTS_DIR = os.path.join(RESULTS_BASE, args.subdir)
