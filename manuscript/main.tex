...
As shown by Schweiger et al.\ and confirmed in our demographic robustness analysis (Fig~\ref{fig:demography}), the flow field generalizes well to non-equilibrium histories ($r = 0.81$--$0.88$ under three diverse \texttt{stdpopsim} models).
Any systematic scale bias under variable $N(t)$ can be corrected by estimating the harmonic-mean $N_e$ from heterozygosity.
